...
The variation of error in simulation with increasing DoF for different values of $N$ is shown in \cref{fig:test1-1_error_plots_chandrashekhar}. \cref{fig:test1-1_dof800_chandrashekhar} shows a visual comparison of the results at the highest resolution (800 DoFs).
